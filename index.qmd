...
listing:
  - id: publications-archival
    contents: "publications/publications-archival.yaml"
    template: html/publications/listing.ejs
    categories: false 
    filter-ui: false
  - id: publications-non-archival
    contents: "publications/publications-non-archival.yaml"
    template: html/publications/listing.ejs
    categories: false 
    filter-ui: false
include-after-body:
...
My research interests are broadly in the fields of (Mechanistic) Interpretability and Graph Neural Networks. I am also a member of the [WISDOM](https://wisdomhorizon.eu/) consortium, developing predictive models for complex diseases (in particular multiple sclerosis).
However, the underlying motivation of understanding the inner workings of neural networks
